...
<body id="page-top">
  ...
  <div class="col-lg-7">
    <div class="card border-0 shadow">
      <div class="card-header bg-primary text-white py-2 px-3">
        <h6 class="mb-0" style="font-size: 13px;"><i class="bi bi-cash-coin me-2"></i>Commission Entry</h6>
      </div>
      <div class="card-body p-3">
        <form id="commissionForm">
          ...
          <div class="row g-2 mb-3">
            <div class="col-md-6">
              <label class="form-label" style="font-size: 12px;">Deal ID</label>
              <input type="text" class="form-control form-control-sm" name="dealId" required>
            </div>
            <div class="col-md-6">
              <label class="form-label" style="font-size: 12px;">Client Name</label>
              <input type="text" class="form-control form-control-sm" name="clientName" required>
            </div>
          </div>
          ...
          <div class="row g-2 mb-3">
            <div class="col-md-4">
              ...
              <select class="form-select form-select-sm" name="commissionType">
                <option value="standard">Standard (10%)</option>
                <option value="custom">Deal-Specific</option>
              </select>
            </div>
            <div class="col-md-4">
              <label class="form-label" style="font-size: 12px;">Commission %</label>
              <input type="number" class="form-control form-control-sm" name="commissionPercent" value="10" readonly>
            </div>
            <div class="col-md-4">
              <label class="form-label" style="font-size: 12px;">Deal Amount (₹)</label>
              <input type="number" class="form-control form-control-sm" name="dealAmount" required>
            </div>
          </div>
          ...
          <div class="row g-2 mb-3">
            <div class="col-md-4">
              <label class="form-label" style="font-size: 12px;">GST Applicable?</label>
              <select class="form-select form-select-sm" name="gstApplicable">
                <option value="yes">Yes (18%)</option>
                <option value="no">No</option>
              </select>
            </div>
            <div class="col-md-4">
              <label class="form-label" style="font-size: 12px;">Commission Status</label>
            ...
            <div class="col-md-4">
              <label class="form-label" style="font-size: 12px;">Total Payable (₹)</label>
              <input type="text" class="form-control form-control-sm bg-body-secondary" name="totalPayable" readonly>
            </div>
          </div>
  ...
  <div class="col-lg-5">
    <div class="card h-100 border-start border-4 border-primary shadow">
      <div class="card-body p-3">
        <h6 class="text-primary mb-3" style="font-size: 13px;"><i class="bi bi-clipboard-data me-2"></i>Live Summary</h6>
...
<!-- Receipt Section -->
<div class="card mt-4 shadow d-none d-print-block" id="receiptCard" style="font-size: 12px;">
