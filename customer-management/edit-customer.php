        ...
        <div class="container-fluid">
          ...
          <h1 class="h3 mb-4 text-gray-800">
            <div class="container py-3 small">
              <div class="card border-0">
                <div class="card-body p-3">
                  <h5 class="mb-3 text-primary fw-bold text-center">Edit Customer</h5>
                  <form id="customerForm" class="needs-validation">
                    <div class="small">
                      <div class="row g-3 p-3">
                        <div class="col-md-6 mb-2">
                          <label class="form-label">Full Name</label>
                          <input type="text" name="fullName" class="form-control form-control-sm" required placeholder="Enter full name">
                        </div>
                        <div class="col-md-6 mb-2">
                          <label class="form-label">Customer Type</label>
                          <select class="form-select form-select-sm" id="customerType" name="customerType" required>
                        ...
                        <div class="col-md-6 mb-2">
                          ...
                          <input type="tel" name="contactNumber" class="form-control form-control-sm" required placeholder="Enter contact number">
                        </div>
                        <div class="col-md-6 mb-2">
                          <label class="form-label">Email</label>
                          <input type="email" name="email" class="form-control form-control-sm" required placeholder="Enter email">
                        </div>
                        <div class="col-md-6 mb-2">
                          <label class="form-label">Upload ID Proof (PDF/JPEG only)</label>
                          <input type="file" name="idProof" class="form-control form-control-sm" id="idProof" accept=".pdf,.jpeg,.jpg" required>
                        </div>
                        <div class="col-md-6 mb-2">
                          <label class="form-label">Budget Range</label>
                          <input type="range" name="budgetRange" class="form-range" min="100000" max="10000000" step="50000" id="budgetRange">
                          <div class="fw-medium small">Budget: <span id="budgetDisplay">₹100000</span></div>
                        </div>
                        <div class="col-md-6 mb-2">
                          <label class="form-label">Preferred Localities / Areas</label>
                          <input type="text" name="preferredLocalities" class="form-control form-control-sm" placeholder="Enter preferred localities or areas">
                        </div>
                        <div class="col-md-6 mb-2">
                        ...
                        <div class="col-md-6 mb-2">
                          ...
                          <input type="text" name="propertyType" class="form-control form-control-sm" placeholder="e.g. Apartment, Villa, Commercial">
                        </div>
                        <div class="col-md-6 mb-2">
                          <label class="form-label">Agent Linked</label>
                          <input type="text" name="agentLinked" class="form-control form-control-sm" placeholder="Enter agent name or ID">
                        </div>
                        <div class="col-md-6 mb-2">
                        ...
                        <div class="col-12 mb-2" id="sellerFields" style="display:none;">
                          <label class="form-label">Owned Property Details</label>
                          <textarea class="form-control form-control-sm" name="ownedPropertyDetails" placeholder="Enter owned property details..."></textarea>
                        </div>
                        <div class="col-12 mb-2" id="tenantFields" style="display:none;">
                          <label class="form-label">Rental Duration</label>
                          <input type="text" name="rentalDuration" class="form-control form-control-sm" placeholder="e.g. 6 months, 1 year">
                        </div>
              ...
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content small">
                  <div class="modal-header">
                    <h6 class="modal-title">Property Match Found</h6>
            ...
            <div class="position-fixed bottom-0 end-0 p-2" style="z-index: 11">
              <div id="noMatchToast" class="toast align-items-center text-bg-warning border-0 small" role="alert">
                <div class="d-flex">
