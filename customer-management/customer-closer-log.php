      ...
      <div class="card-body p-4">
        <form id="closureForm" name="closureForm" novalidate>
          ...
          <div class="mb-4">
            ...
            <textarea class="form-control" name="propertyFinalized" rows="2" placeholder="Details of finalized property" required></textarea>
          </div>
          ...
          <div class="row g-3 mb-4">
            <div class="col-md-6">
              ...
              <div class="input-group">
                ...
                <input type="number" class="form-control" name="transactionValue" placeholder="Transaction Amount" required>
              </div>
            </div>
            <div class="col-md-6">
              ...
              <div class="input-group mb-2">
                ...
                <input type="number" class="form-control" name="commissionAmount" placeholder="Commission Amount">
              </div>
          ...
          <div class="row mb-4 align-items-end">
            <div class="col-md-6">
              ...
              <select class="form-select" id="assignAgent" name="assignedAgent" required>
          ...
          <div class="row pt-3 border-top">
            <div class="col-md-6 mb-3 mb-md-0">
              <button type="submit" class="btn btn-success w-100" name="submitForm">
                <i class="bi bi-check2-circle me-1"></i>Submit & Trigger CRM
              </button>
            </div>
            <div class="col-md-6">
              <button type="button" id="downloadPDF" name="downloadPDF" class="btn btn-outline-dark w-100">
